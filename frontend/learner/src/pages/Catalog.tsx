...
export default function CatalogPage() {
  ...
  return (
    <div className="p-6 md:p-8 space-y-10 max-w-6xl mx-auto animate-fade-in">
      {/* Page Header */}
      <div>
        <h1 className="text-2xl font-bold font-display text-navy-900 tracking-tight">My Learning</h1>
        <p className="text-sm text-navy-400 mt-1">Pick up where you left off or start something new</p>
      </div>
        ...
        <>
          ...
          {enrolled.length > 0 && (
            <section className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-sm font-semibold font-display text-navy-600 uppercase tracking-wider">
          ...
          {courses.length === 0 && (
            <div className="flex flex-col items-center justify-center py-24 text-center">
              ...
              <p className="text-navy-700 font-semibold font-display text-lg">No courses available yet</p>
              <p className="text-navy-400 text-sm mt-1.5 max-w-xs">
    ...
    <Link to={`/courses/${course.id}`} className="group block">
      ...
      >
        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          {/* Title */}
          <h3 className="font-semibold font-display text-navy-800 text-sm leading-snug mb-1 group-hover:text-indigo-600 transition-colors line-clamp-2">
            {course.title}
          </h3>
          {course.description && (
            <p className="text-xs text-navy-400 line-clamp-2 mb-3">{course.description}</p>
          )}
          ...
          {/* Progress + meta — pushed to bottom */}
